...
## ✅ REQUIRED - Core Application (Must have to run)
...
## ⭐ RECOMMENDED - Enhanced Features (Highly recommended)
...
### 6. Anthropic Claude (AI Damage Analysis)
```bash
ANTHROPIC_API_KEY=your_anthropic_api_key_here
```

**Features Enabled:**
- ✅ AI photo damage analysis with Claude Vision
...
**Cost:**
- Claude 3.5 Sonnet: ~$0.003 per image analysis (3x cheaper than GPT-4V)
- Typical: $5-15/month for small shop
...
## 🎯 Minimum Viable Setup (To Get Started Today)
...
| Claude (Anthropic) | ~$5-15 | AI damage analysis (3x cheaper!) |
| SendGrid | $0 (Free tier) | Email notifications |
| **TOTAL** | **~$10-25/month** | Full featured system |
